"""
Memory backend operator registry.
...
from search_query_dsl.backends.memory.operators.standard import (
    EqualOperator,
    NotEqualOperator,
    GreaterThanOperator,
    LessThanOperator,
...
from search_query_dsl.backends.memory.operators.string import (
    LikeOperator,
    NotLikeOperator,
    ILikeOperator,
    ContainsOperator,
...
from search_query_dsl.backends.memory.operators.set import (
    InOperator,
    NotInOperator,
    BetweenOperator,
    NotBetweenOperator,
...
from search_query_dsl.backends.memory.operators.null import (
    IsNullOperator,
    IsNotNullOperator,
)
from search_query_dsl.backends.memory.operators.jsonb import (
...
from search_query_dsl.backends.memory.operators.geometry import (
    IntersectsOperator,
    DWithinOperator,
    WithinOperator,
...
REGISTRY: Dict[str, MemoryOperator] = {}


def _register(op: MemoryOperator, alias: Optional[str] = None) -> MemoryOperator:
...
_register(IContainsOperator()) # icontains
